          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('doctor.visits.update', $visit->id) }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="time_start" name="time_start" value="{{ old('time_start', $visit->time_start) }}" />
              </div>
              <div class="form-group">
                <label for="time_end">Time End</label>
                <input type="text" class="form-control" id="time_end" name="time_end" value="{{ old('time_end', $visit->time_end) }}" />
              </div>
              <div class="form-group">
                <label for="duration_of_visit">Duration of Visit</label>
                <input type="text" class="form-control" id="duration_of_visit" name="duration_of_visit" value="{{ old('duration_of_visit', $visit->duration_of_visit) }}" />
              </div>
              <div class="form-group">
